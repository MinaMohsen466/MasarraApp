...
}> = ({ onBack, token, onShowMapPicker, onHideMapPicker }) => {
            ...
            try {
              ...
              if (!fineGranted && !coarseGranted) {
                ...
                try {
                  ...
                  if (__DEV__)
                    console.warn(
                      'Error requesting Android permissions:',
                      reqErr,
                    );
                }
              }
        ...
        {onBack && (
          <TouchableOpacity
            style={[
              ...
              { top: insets.top + 10 },
              isRTL
                ? styles.floatingBackButtonRTL
                : styles.floatingBackButtonLTR,
            ]}
            onPress={onBack}
            activeOpacity={0.8}
          >
      ...
      <View style={styles.bottomSheetContainer}>
        ...
        {showForm ? (
          ...
          <View style={styles.flex1}>
            ...
            <View
              style={[styles.modalHeaderRow, isRTL && styles.modalHeaderRowRTL]}
            >
          ...
          <View style={styles.flex1}>
            ...
            <View
              style={[styles.listHeaderRow, isRTL && styles.listHeaderRowRTL]}
            >
              ...
              <TouchableOpacity
                style={[
                  styles.listHeaderAddButton,
                  isRTL && styles.listHeaderAddButtonRTL,
                ]}
                    ...
                    <>
                      {addresses.map(addr => {
                        const isHome =
                          ...
                          addr.name.includes('بيت') ||
                          addr.name.includes('منزل');
                        const isWork =
                          addr.name.toLowerCase().includes('work') ||
                          addr.name.includes('عمل');
                                ...
                                >
                                  <View
                                    style={[
                                      ...
                                      addr.isDefault &&
                                        styles.addressIconContainerDefault,
                                  ...
                                  >
                                    ...
                                    {addr.isDefault ? (
                                      ...
                                      >
                                        <Text
                                          style={
                                            styles.setDefaultBadgeInlineText
                                          }
                                        >
                                          {isRTL
                                            ? 'جعله افتراضي'
