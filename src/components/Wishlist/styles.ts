...
export const styles = StyleSheet.create({
  ...
  cardVertical: { backgroundColor: colors.background, borderRadius: 10, overflow: 'hidden', marginBottom: 12, elevation: 2, shadowColor: colors.shadow, shadowOpacity: 0.04, shadowRadius: 6, alignSelf: 'center', width: '92%', maxWidth: 360 },
  cardImageVertical: { width: '100%', height: 120, backgroundColor: colors.backgroundLight, borderTopLeftRadius: 10, borderTopRightRadius: 10 },
  ...
  removeBtn: { paddingHorizontal: 8, paddingVertical: 4, backgroundColor: colors.background, borderRadius: 6, borderWidth: 1, borderColor: colors.border },
  ...
  footerNote: { marginTop: 16, padding: 12, backgroundColor: colors.backgroundLight, borderRadius: 8 },
